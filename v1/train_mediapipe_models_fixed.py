...
def train_sentence_lstm():
    """Train sentence-level LSTM with MediaPipe features - FIXED VERSION"""
    print("\n🤖 Training MediaPipe Sentence LSTM (FIXED)")
    print("=" * 45)
...
def main():
    ...
    if word_acc > 0.8 and lstm_acc > 0.6:
        print("🎉 Great results! Ready for live translation.")
    elif word_acc > 0.7:
        print("👍 Word classifier works well! LSTM needs improvement but usable.")
    else:
