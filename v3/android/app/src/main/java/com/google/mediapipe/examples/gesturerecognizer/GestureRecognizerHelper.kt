...
class GestureRecognizerHelper(
    ...
    fun recognizeLiveStream(
        ...
        // val imageProxy.close() is not needed here with the 'use' block.
        ...
        val matrix = Matrix().apply {
            ...
            // This is the fix for the reversed landmarks.
            // It flips the image horizontally for the front camera.
            // Remove the hardcoded `postScale` if you want to support both cameras.
            postScale(
                -1f,
                1f,
